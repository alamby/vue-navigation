...
<div id="app mdui-container">
  ...
  <div class="footer mdui-card mdui-col-xs-12">
      <ul class="social-buttons">
        <li><a href="https://github.com/alamby" target="_blank"><img src="./assets/img/footer/github.svg" alt="" width="24px" height="24px;"></a></li>
        <li><a href="https://www.zhihu.com/people/uestcs" target="_blank"><img src="./assets/img/footer/zhihu.svg" alt="" width="24px" height="24px;"></i></a></li>
        <li><a href="https://blog.fanc.win" target="_blank"><img src="./assets/img/footer/about.svg" alt="" width="24px" height="24px;"></i></a></li>
      </ul>

      <p class="copyright">
        Made by <a href="https://www.fanc.win" target="_blank">Chaofan</a>
      </p>
  </div>
...
$(document).ready(function() {
  $(".setCity").click(function(){
    Store.setCookie('citycode', $(".area").val(), 365);
  });
  // City select
  $.cxSelect.defaults.url = "http://oin4m5pbd.bkt.clouddn.com/cityid.min.json";
  $("#cities").cxSelect({
  ...
  (async function request() {
    weatherJson = await getweather(url);
    fillWeather();
  })();
  ...
  function fillWeather() {
    ...
    weather[4] = weatherJson.result.daily[4].day.weather;
    temp[0] = weatherJson.result.templow + "~" + weatherJson.result.temphigh + "℃";
    temp[1] = weatherJson.result.daily[1].night.templow + "~" + weatherJson.result.daily[1].day.temphigh + "℃";
    temp[2] = weatherJson.result.daily[2].night.templow + "~" + weatherJson.result.daily[2].day.temphigh + "℃";
    temp[3] = weatherJson.result.daily[3].night.templow + "~" + weatherJson.result.daily[3].day.temphigh + "℃";
    temp[4] = weatherJson.result.daily[4].night.templow + "~" + weatherJson.result.daily[4].day.temphigh + "℃";

    $(".now_city_edit").html(weatherJson.result.city);
    $(".now_city").html(weatherJson.result.city);
    $(".now_temp").html(weatherJson.result.templow + "~" + weatherJson.result.temphigh + "℃");
...
if (!Store.getCookie('visited')) {
  ...
  if(!Store.getCookie("citycode")){
    Store.setCookie("citycode", 101270101, 365);
  }
}
